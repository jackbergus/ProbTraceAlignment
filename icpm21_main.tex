...
\thanks{This research has been supported by the project IDEE FESR1133 funded by the Eur.\ Reg.\ Development Fund (ERDF) Investment for Growth and Jobs Programme 2014-2020, and by the UNIBZ projects VERBA and CAT.}
}
...
\and
\IEEEauthorblockN{4\textsuperscript{th} Rafael Pe\~{n}aloza\orcidlink{0000-0002-2693-5790}}
...
\author{
	\IEEEauthorblockN{
		...
		Rafael Pe\~{n}aloza\orcidlink{0000-0002-2693-5790}\IEEEauthorrefmark{2}}
...
%\input{sections/04_working_assumptions}
%\input{sections/05_pipeline_sketch}
\input{sections/06_embedding_proposal}
...
%subsubsection and a table, you might find that \tablename~I has been cross
%referenced as \tablename~IV-B3.
%
...
%``\figurename~~\ref{fig}'', even at the beginning of a sentence.
%
%\begin{table}[htbp]
%\caption{\tablename~Type Styles}
%\begin{center}
%\begin{tabular}{|c|c|c|c|}
%\hline
%\textbf{Table}&\multicolumn{3}{|c|}{\textbf{\tablename~Column Head}} \\
%\cline{2-4}
%\textbf{Head} & \textbf{\textit{\tablename~column subhead}}& \textbf{\textit{Subhead}}& \textbf{\textit{Subhead}} \\
%\hline
%copy& More table copy$^{\mathrm{a}}$& &  \\
%\hline
%\multicolumn{4}{l}{$^{\mathrm{a}}$Sample of a \tablename~footnote.}
%\end{tabular}
%\label{tab1}
%\end{center}
%\end{table}
