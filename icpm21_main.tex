...
\author{
	\IEEEauthorblockN{
		Giacomo Bergami\IEEEauthorrefmark{1},
		Fabrizio Maria Maggi\IEEEauthorrefmark{1},
		Marco Montali\IEEEauthorrefmark{1},
		Rafael Peñaloza\IEEEauthorrefmark{2}}
...
\input{sections/Α_introduction}
\input{sections/Β_related_works}
\input{sections/Γ_preliminaries}
\input{sections/Δ_working_assumptions}
%\input{sections/Ε_pipeline_sketch}
\input{sections/Ζ_embedding_proposal}
\input{sections/Η_experiments}
\input{sections/Θ_conclusions}
