...
\begin{figure}[!t]
	\centering
	\vspace{-4mm}
	\subfloat{\label{fig:spp}\includegraphics[width=.248\textwidth]{images/original_space.pdf}}
	\subfloat{\label{fig:knnspace}\includegraphics[width=.248\textwidth]{images/transformed_space.pdf}}\\
