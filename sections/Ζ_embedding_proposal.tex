...
\begin{table}[!t]
	...
	\vspace{-0.2cm}
\end{table}
Our proposed embedding $\gorgembed$ \cite{Bergami21} can be now exploited for each  $wTG_\nonlogtrace$ as follows:
...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{\begin{tabular}{lllllllllllll}
			...
			\midrule		
			$\gorgembed(\overline{G}_\const{aaaa})$ & $1.00\cdot 10^{-24}$ & $0$   & $0$   & $6.44\cdot 10^{-26}$ & $0$& $0$& $0$& $0$& $0$    &$0$& $0$& $0$ \\
