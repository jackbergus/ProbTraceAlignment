...
For experimenting our proposed approach to probabilistic trace alignment, we used the Sepsis Cases event log.\footnote{{\small \texttt{https://data.4tu.nl/articles/}\\
		\texttt{Sepsis\_Cases\_-\_Event\_Log/12707639}}} In particular, we
