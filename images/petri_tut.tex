...
\begin{document}
	...
	\node [
      ...
      label={[right,yshift=-1mm]$\wcolor 1.0$},
    ] (t1) {};
	\node [
      place,
      right=7mm of t1
	...
	\node [
      ...
      label={[right,yshift=-1mm]$\wcolor 0.9$},
    ] (te1) {};
	\node [
      place, 
      right=of te1
...
%    ] {$p_5$};
	...
	\node [
      ...
      label={[right,yshift=-1mm]$\color{magenta} 0.1$}
    ] (tc1) {};
%	\node [
%      place,
%      right=of tc1
...
%    
    \draw[arc] (i) -- (t1);
    \draw[arc] (t1) -- (p2);
    \draw[arc,rounded corners=5pt] (p2) |- (te1);
    \draw[arc] (te1) -- (p3);
    \draw[arc] (p3) -- (ta1);
%    \draw[arc] (ta1) -- (p5);
    %\draw[arc] (p5) -- (te2);
     \draw[arc,rounded corners=5pt] (p2) |- (tc1);
    \draw[arc,rounded corners=5pt] (tc1) -| (f);
    \draw[arc,rounded corners=5pt] (ta1) -| (f);
