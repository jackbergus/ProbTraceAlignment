...
\begin{document}
	...
	\node [
      transitionV,
      right=7mm of i,
      label=below:$\tcolor\textit{close order}$,
	...
	\node [
      transitionV,
      above right=of p2,
      label=below:$\tcolor\textit{accept order}$,
    ...
    \node [
      transitionV,
      right=8mm of p3,
      label=below:$\tcolor \textit{pay order}$,
      label=above:$\wcolor 1.0$,
    ] (ta1) {};
%	\node [
%      place,
...
%    ] {$p_5$};
	...
	\node [
      transitionV,
      below right=of p2,
      label=below:$\tcolor \textit{refuse order}$,
...
%    ] (tb1) [right=of p6] {};
    ...
    transitionV,
    right=1cm of f,
    label=below:$\tcolor\textit{archive order}$,
    label=above:$\wcolor 1.0$,
    ] (tf1) {};
